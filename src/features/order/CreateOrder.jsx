    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          {!position.latitude && !position.ongitude && (
            <span className="z-1 absolute right-0 top-0 sm:right-[3px] sm:top-[3px] md:right-[5px] md:top-[5px]">
              <Button
                type="small"
                disabled={isLoadingAddress}
                onClick={(e) => {
        ...
        <div className="mb-12 flex items-center gap-5">
          ...
          <label htmlFor="priority" className="font-medium">
            Want to yo give your order priority? (add extra 20% to the price)
          </label>
        </div>
